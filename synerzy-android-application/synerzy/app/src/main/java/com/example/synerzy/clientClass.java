        ...
        public static String getMessageClient( String ipAddress , int socket_port) {
            ...
            while (c == 0) {
                try {
                    ...
                    if(receivedByte.actualLength !=0){
                        c =1;
                    System.out.println("syn: message recieved: "+ getStringFrombyteClass(receivedByte));
        ...
        public static byteClass getFile(String ipAddress , int portnum,String fileName){
            ...
            while(c==0) {
                try {
                    ...
                    System.out.println("syn: file received + clientClass" + byteReceived.actualLength);
                    if(byteReceived.actualLength !=0){
                        c=1;
                    }
                } catch (Exception e) {
                    e.printStackTrace();
