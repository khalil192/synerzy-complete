package com.example.synerzy.adapter;
...
import com.example.synerzy.R;
import com.example.synerzy.VideoPlayerActivtit;
import com.example.synerzy.interfaces.ClickListener;
import com.example.synerzy.models.VideoModel;
import com.example.synerzy.videoPlayer;
...
public class VideoItemAdapter extends RecyclerView.Adapter{
    ...
    public VideoItemAdapter(List<VideoModel> videoModels, Context context, videoPlayer clickListener) {
